...
public:
    ...
    void setupUi(QDialog *KSJDemoQT_Matrix)
    {
        ...
        EXPOSURE_TIME_RANGE_Label->setGeometry(QRect(880, 60, 71, 21));
        ...
        EXPOSURE_LINES_RANGE_Label->setGeometry(QRect(880, 100, 71, 21));
        GAIN_RANGE_Label = new QLabel(KSJDemoQT_Matrix);
        GAIN_RANGE_Label->setObjectName(QStringLiteral("GAIN_RANGE_Label"));
        GAIN_RANGE_Label->setGeometry(QRect(880, 170, 71, 21));
        ...
        groupBox_2->setGeometry(QRect(550, 370, 331, 141));
