...
public:
    ...
    void setupUi(QDialog *KSJSCZDemoMainWindow)
    {
        ...
        DevicesComboBox->setGeometry(QRect(10, 10, 222, 28));
        ...
        TrigetComboBox->setGeometry(QRect(10, 84, 222, 28));
        ...
        MessageInfoLabel->setGeometry(QRect(10, 402, 222, 85));
        ...
        RowStartSpinBox->setGeometry(QRect(14, 52, 59, 22));
        ...
        ColSizeSpinBox->setGeometry(QRect(88, 20, 59, 22));
        ...
        RowSizeSpinBox->setGeometry(QRect(88, 52, 59, 22));
        ...
        SetFovPushButton->setGeometry(QRect(156, 28, 55, 36));
