...
resultV = libKsj.KSJ_SetFixedFrameRateEx(0, c_float(40))
print("KSJ_SetFixedFrameRateEx0 error code = %d" % (resultV))
resultV = libKsj.KSJ_SetFixedFrameRateEx(1, c_float(40))
...
while 1:
    ...
    if retValue1 != 0:
        ...
        img = Image.frombytes('RGB', (1280, 960), pRawData1)
        img.save("image0.jpg")
    ...
    if retValue2 != 0:
        ...
        img = Image.frombytes('RGB', (1280, 960), pRawData2)
        img.save("image1.jpg")
